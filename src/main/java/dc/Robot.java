...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    leftMaster = new CANSparkMax(7, MotorType.kBrushless);
    ...
    CANSparkMax leftSlave0 = new CANSparkMax(8, MotorType.kBrushless);
    leftSlave0.follow(leftMaster);
    leftSlave0.setIdleMode(IdleMode.kBrake);

    CANSparkMax rightSlave0 = new CANSparkMax(6, MotorType.kBrushless);
    rightSlave0.follow(rightMaster);
    rightSlave0.setIdleMode(IdleMode.kBrake);

    WPI_TalonSRX spareTalon = new WPI_TalonSRX(21);
    ...
    PigeonIMU pigeon = new PigeonIMU(spareTalon);
    gyroAngleRadians = () -> {
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putNumber("gyro angle", gyroAngleRadians.get());
  }
